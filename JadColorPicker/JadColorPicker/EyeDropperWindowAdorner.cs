...
namespace JadColorPicker
{
    internal class EyeDropperWindowAdorner : Adorner
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            // color display
            var text = new FormattedText($"#{ColorConverter.RgbToHex(new RGB(Color.R, Color.G, Color.B)).Value}", CultureInfo.InvariantCulture, FlowDirection.LeftToRight, Typeface, 24, Brushes.Black, VisualTreeHelper.GetDpi(this).PixelsPerDip);
